...
import com.example.android.politicalpreparedness.election.adapter.ElectionListAdapter.ElectionViewHolder.Companion.from
import com.example.android.politicalpreparedness.network.models.Channel
import com.example.android.politicalpreparedness.representative.adapter.RepresentativeListAdapter.RepresentativeViewHolder
import com.example.android.politicalpreparedness.representative.model.Representative
import java.util.Date.from


class RepresentativeListAdapter(private val representativeListener: RepresentativeClickListener) :
    ListAdapter<Representative, RepresentativeViewHolder>(RepresentativeDiffCallback()) {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RepresentativeViewHolder {
        val layoutInflater = LayoutInflater.from(parent.context)
        val view = layoutInflater
            .inflate(R.layout.list_item_representative, parent, false) as ConstraintLayout
        return RepresentativeViewHolder.from(view)
    }
    ...
    override fun onBindViewHolder(holder: RepresentativeViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            representativeListener.onClick(representative)
        }
    }
...
class RepresentativeViewHolder(val binding: ListItemRepresentativeBinding): RecyclerView.ViewHolder(binding.root) {
    ...
    fun bind(item: Representative) {
        ...
        binding.represenativePic.setImageResource(R.drawable.ic_profile)
    ...
    private fun showWWWLinks(urls: List<String>) {
        enableLink(binding.worldwidewebImageView, urls.first())
    }
